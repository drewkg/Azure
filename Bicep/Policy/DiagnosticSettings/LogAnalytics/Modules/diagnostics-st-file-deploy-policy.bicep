...
resource policy 'Microsoft.Authorization/policyDefinitions@2019-09-01' = {
  ...
  properties: {
    displayName: 'Deploy Diagnostics & Metrics for Storage Account File Services  a Log Analytics workspace'
                ...
                resources: [
                  {
                    ...
                    scope: '[resourceId(\'Microsoft.Storage/storageAccounts/fileServices\', split(parameters(\'resourceName\'), \'/\')[0], split(parameters(\'resourceName\'), \'/\')[1])]'
                    properties: {
                      workspaceId: '[parameters(\'log Analytics\')]'
                      metrics: [
                        {
                          category: 'AllMetrics'
                          enabled: true
